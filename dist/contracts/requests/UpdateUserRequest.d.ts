...
export declare const zUpdateUserRequest: z.ZodObject<{
    ...
    onboardingStage: z.ZodOptional<z.ZodEnum<typeof import("../data").OnboardingStage>>;
    ...
    status: z.ZodOptional<z.ZodEnum<typeof import("../data").UserStatus>>;
    ...
    membershipCardStatus: z.ZodOptional<z.ZodEnum<typeof import("../data").MembershipDeliverableStatus>>;
    membershipMerchStatus: z.ZodOptional<z.ZodEnum<typeof import("../data").MembershipDeliverableStatus>>;
    shirtSize: z.ZodOptional<z.ZodNullable<z.ZodEnum<typeof import("../data").ShirtSize>>>;
    duesPayingMember: z.ZodOptional<z.ZodBoolean>;
    membershipFulfillmentStatus: z.ZodOptional<z.ZodNullable<z.ZodEnum<typeof import("../data").MembershipFulfillmentStatus>>>;
